const app = {
    ...
    router() {
        ...
        } else if (hash === 'admin-contacts' && Store.user?.role === 'admin') {
...
ФИО руководителя: Головнев Дмитрий Иванович<br>
                    ...
                    <div class="admin-sidebar">
                        <div class="admin-card">
                            ...
                            <ul class="side-menu-links">
                                ...
                                <li><a href="javascript:void(0)" onclick="app.navigate('admin-contacts')">Заявки (Контакты)</a></li>
    ...
    renderAdminContacts() {
        const reqHtml = Store.requests.length === 0 ? '<p>Заявок пока нет.</p>' : Store.requests.map(r => `
        ...
        this.contentDiv.innerHTML = `
            <div class="view active container">
                <div class="admin-layout">
                    <div class="admin-sidebar">
                        <div class="admin-card">
                            ...
                            <ul class="side-menu-links">
                                ...
                                <li><a href="javascript:void(0)" style="color:#f57c00;">Заявки (Контакты)</a></li>
                                <li><a href="javascript:void(0)" onclick="app.doLogout()">Выйти</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="admin-content">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                            <h2>Отправленные заявки из Контактов</h2>
                        </div>
                        <div class="admin-product-list">
                            ${reqHtml}
                        </div>
